...
hobby_choice = st.selectbox(
    "가장 좋아하는 취미를 선택하세요:", list(hobby_categories.keys()))
skill_choice = st.selectbox("가장 뛰어난 특기를 선택하세요:", list(skill_categories.keys()))
like_choice = st.selectbox("가장 좋아하는 것을 선택하세요:", list(like_categories.keys()))
